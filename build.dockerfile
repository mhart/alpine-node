FROM alpine:3.7
ENV VERSION=v10.21.0 NPM_VERSION=6 YARN_VERSION=latest

# FROM alpine:3.9
# ENV VERSION=v12.18.0 NPM_VERSION=6 YARN_VERSION=latest

# FROM alpine:3.10
# ENV VERSION=v13.14.0 NPM_VERSION=6 YARN_VERSION=latest
