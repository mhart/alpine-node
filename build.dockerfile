# FROM alpine:3.7
# ENV VERSION=v10.23.3 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python

# FROM alpine:3.9
# ENV VERSION=v12.20.2 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python

# FROM alpine:3.11
# ENV VERSION=v14.15.5 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3

FROM alpine:3.12
ENV VERSION=v15.10.0 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3
