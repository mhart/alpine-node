# FROM alpine:3.7
# ENV VERSION=v10.23.1 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python
...
FROM alpine:3.12
ENV VERSION=v15.6.0 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3
