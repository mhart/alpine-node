...
# FROM alpine:3.9
# ENV VERSION=v12.22.1 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python

# FROM alpine:3.11
# ENV VERSION=v14.16.1 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3

# FROM alpine:3.12
# ENV VERSION=v15.14.0 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3

FROM alpine:3.13
ENV VERSION=v16.2.0 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3
