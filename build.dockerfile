...
FROM alpine:3.11
ENV VERSION=v14.15.2 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3

# FROM alpine:3.12
# ENV VERSION=v15.4.0 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3
