# FROM alpine:3.9
# ENV VERSION=v12.19.1 NPM_VERSION=6 YARN_VERSION=v1.22.10

# FROM alpine:3.11
# ENV VERSION=v14.15.1 NPM_VERSION=6 YARN_VERSION=v1.22.10

FROM alpine:3.12
ENV VERSION=v15.4.0 NPM_VERSION=7 YARN_VERSION=v1.22.10
