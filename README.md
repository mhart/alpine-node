...
Versions v13.8.0, v12.16.0, v10.19.0, v8.17.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  ...
  - `12`, `12.16`, `12.16.0` – 81.7 MB (npm 6.13.7, yarn 1.22.0)
...
- Slim install with no npm or yarn:
  ...
  - `slim-12`, `slim-12.16`, `slim-12.16.0` – 45.8 MB
