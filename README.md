...
Versions v12.9.0, v10.16.3, v8.16.1, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `12`, `12.9`, `12.9.0` – 78.8 MB (npm 6.11.0, yarn 1.17.3)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-12`, `slim-12.9`, `slim-12.9.0` – 44.8 MB
