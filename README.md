...
Versions v10.3.0, v8.11.2, v6.14.2, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `10`, `10.3`, `10.3.0` – 78.3 MB (npm 6.1.0, yarn 1.7.0)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-10`, `base-10.2`, `base-10.2.1` – 45.6 MB
