...
Versions v12.1.0, v10.15.3, v8.16.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `12`, `12.1`, `12.1.0` – 76.1 MB (npm 6.9.0, yarn 1.15.2)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-12`, `slim-12.1`, `slim-12.1.0` – 44.9 MB
