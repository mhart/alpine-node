...
Versions v10.4.1, v8.11.3, v6.14.3, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `10`, `10.4`, `10.4.1` – 78.4 MB (npm 6.1.0, yarn 1.7.0)
  - `8`, `8.11`, `8.11.3` – 69.3 MB (npm 5.10.0, yarn 1.7.0)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-10`, `base-10.4`, `base-10.4.0` – 45.7 MB
  - `base-8`, `base-8.11`, `base-8.11.2` – 42.9 MB
