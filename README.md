...
Versions v11.4.0, v10.14.0, v8.14.0, v6.15.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `11`, `11.4`, `11.4.0` – 69.8 MB (npm 6.4.1, yarn 1.12.3)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-11`, `base-11.4`, `base-11.4.0` – 47.9 MB
