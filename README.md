...
Versions v12.7.0, v10.16.1, v8.16.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  ...
  - `10`, `10.16`, `10.16.1` – 74 MB (npm 6.10.2, yarn 1.17.3)
...
- Slim install with no npm or yarn:
  ...
  - `slim-10`, `slim-10.16`, `slim-10.16.1` – 41.3 MB
