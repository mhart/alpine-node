...
Versions v9.1.0, v8.9.0, v6.12.0, v4.8.6, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `9`, `9.1`, `9.1.0` – 65.9 MB (npm 5.5.1, yarn 1.3.2)
  - `8`, `8.9`, `8.9.0` – 66.3 MB (npm 5.5.1, yarn 1.2.1)
- Full install build with npm:
  - `6`, `6.12`, `6.12.0` – 49.4 MB (npm 3.10.10)
  - `4`, `4.8`, `4.8.6` – 35.3 MB (npm 2.15.12)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-9`, `base-9.0`, `base-9.0.0` – 42.9 MB
  - `base-8`, `base-8.9`, `base-8.9.0` – 43.2 MB
  - `base-6`, `base-6.11`, `base-6.11.5` – 38.5 MB
  - `base-4`, `base-4.8`, `base-4.8.5` – 27.3 MB
