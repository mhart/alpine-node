...
Versions v12.3.0, v10.15.3, v8.16.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `12`, `12.3`, `12.3.0` – 78 MB (npm 6.9.0, yarn 1.16.0)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-12`, `slim-12.3`, `slim-12.3.0` – 45 MB
