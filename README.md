...
Versions v15.12.0, v14.15.5, v12.20.2, v10.24.0, v8.17.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `15`, `15.12`, `15.12.0` – 107 MB (npm 7.6.3, yarn 1.22.10)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-15`, `slim-15.12`, `slim-15.12.0` – 76.6 MB
