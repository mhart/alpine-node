...
Versions v14.10.1, v12.18.3, v10.22.0, v8.17.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `14`, `14.10`, `14.10.1` – 109 MB (npm 6.14.8, yarn 1.22.5)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-14`, `slim-14.10`, `slim-14.10.1` – 74 MB
