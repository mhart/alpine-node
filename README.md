...
Versions v13.1.0, v12.13.1, v10.17.0, v8.16.2, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `13`, `13.1`, `13.1.0` – 110 MB (npm 6.13.0, yarn 1.19.1)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-13`, `slim-13.1`, `slim-13.1.0` – 70 MB
