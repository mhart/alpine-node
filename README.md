...
Versions v10.5.0, v8.11.3, v6.14.3, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `10`, `10.5`, `10.5.0` – 78.6 MB (npm 6.1.0, yarn 1.7.0)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-10`, `base-10.5`, `base-10.5.0` – 45.8 MB
