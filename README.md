...
Versions v14.3.0, v13.14.0, v12.17.0, v10.20.1, v8.17.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  ...
  - `12`, `12.17`, `12.17.0` – 80.7 MB (npm 6.14.5, yarn 1.22.4)
...
- Slim install with no npm or yarn:
  ...
  - `slim-12`, `slim-12.17`, `slim-12.17.0` – 46.4 MB
