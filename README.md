...
Versions v11.12.0, v10.15.3, v8.15.1, v6.17.0, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `11`, `11.12`, `11.12.0` – 73.9 MB (npm 6.9.0, yarn 1.15.2)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-11`, `base-11.11`, `base-11.11.0` – 49.2 MB
