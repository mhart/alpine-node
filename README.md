...
Versions v15.2.0, v14.15.0, v12.19.0, v10.23.0, v8.17.0, v6.17.1, v4.9.1, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `15`, `15.2`, `15.2.0` – 107 MB (npm 7.0.10, yarn 1.22.10)
...
- Slim install with no npm or yarn:
  - `slim`, `slim-15`, `slim-15.2`, `slim-15.2.0` – 75.9 MB
