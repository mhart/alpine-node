...
Versions v8.6.0, v6.11.3, v4.8.4, v0.12.18 and v0.10.48 –
...
- Full install built with npm and yarn:
  - `latest`, `8`, `8.6`, `8.6.0` – 65.9 MB (npm 5.4.2, yarn 1.1.0)
- Full install build with npm:
  - `6`, `6.11`, `6.11.3` – 49.4 MB (npm 3.10.10)
...
- Base install with node built as a static binary with no npm or yarn:
  - `base`, `base-8`, `base-8.6`, `base-8.6.0` – 45.5 MB
  - `base-6`, `base-6.11`, `base-6.11.3` – 37.8 MB
